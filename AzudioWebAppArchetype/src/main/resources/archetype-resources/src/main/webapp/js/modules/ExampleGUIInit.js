...
"dgrid/OnDemandGrid", "dojo/store/Memory", "dijit/Tree", "dijit/tree/ObjectStoreModel", "dojo/data/ObjectStore", "dgrid/Tree", "dgrid/Keyboard", "dgrid/Selection"], function(

OnDemandGrid, Memory, Tree, ObjectStoreModel, ObjectStore) {
